          ...
          <div>
            ...
            <Field name="title" v-slot="{ field, errors }">
              <input
                ...
                class="w-full px-4 py-2 border rounded-lg bg-input focus:outline-none focus:ring-2 focus:ring-ring transition text-sm"
          ...
          <div>
            ...
            <Field name="description" v-slot="{ field, errors }">
              <textarea
                ...
                class="w-full px-4 py-2 border rounded-lg bg-input focus:outline-none focus:ring-2 focus:ring-ring transition min-h-32 text-sm"
                :class="errors[0] ? 'border-red-500' : 'border-border'"
              ></textarea>
              <p
                v-if="errors[0]"
